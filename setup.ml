...
(* OASIS_START *)
(* DO NOT EDIT (digest: db6c07bb3b27fb3b4bf6c2701c88ed80) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          copyrights = [];
          maintainers = [];
          authors = ["Lucius Gregory Meredith"];
          homepage = None;
          synopsis =
            "Cacao is a language built from the ground up for reading,\nwriting and running distributed programs.";
          description = None;
          categories = [];
            ...
            [
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "Cacao.ml"})
            ];
     ...
     oasis_version = "0.4.4";
     oasis_digest = Some "k\139^\205\147\199\180\0221\188\146\023F\012$\146";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
