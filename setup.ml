...
(* OASIS_START *)
(* DO NOT EDIT (digest: a758e6038a9040dc1d5dbe16d3505e8c) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          homepage = None;
          synopsis =
            "DaVinci is a language built from the ground up for reading,\nwriting and running distributed programs.";
          description = None;
          categories = [];
            ...
            [
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "DaVinci.ml"})
            ];
     ...
     oasis_version = "0.4.1";
     oasis_digest = Some "\005\t\199\154TD\164\141N\182C\133\139-s\254";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
