...
let _ = List.iter (fun (kwd, tok) -> Hashtbl.add symbol_table kwd tok)
                  [("|-", SYMB1);(":", SYMB2);("|=", SYMB3);(":!", SYMB4);(";", SYMB5);(";;", SYMB6);("=", SYMB7);("->", SYMB8);("(", SYMB9);(")", SYMB10);("|", SYMB11);("<", SYMB12);(">", SYMB13);("<=", SYMB14);(">=", SYMB15);("!", SYMB16);("/", SYMB17);("+", SYMB18);("*", SYMB19);("::", SYMB20);("-", SYMB21);("<-", SYMB22);("@Seq", SYMB23);("@App", SYMB24);("@Let", SYMB25);("@Letrec", SYMB26);("@Abs", SYMB27);("@Cond", SYMB28);("@SelectFrom", SYMB29);("@From", SYMB30);("@SelectFromWhere", SYMB31);("@FromWhere", SYMB32);("@Equate", SYMB33);("@CompLT", SYMB34);("@CompGT", SYMB35);("@CompLTE", SYMB36);("@CompGTE", SYMB37);("@Unquote", SYMB38);("@Newprompt", SYMB39);("@Suspend", SYMB40);("@Release", SYMB41);("@SuspendSub", SYMB42);("@Divide", SYMB43);("@Add", SYMB44);("@Multiply", SYMB45);("@Juxtapose", SYMB46);("@Negate", SYMB47);("`", SYMB48);("'", SYMB49);("[", SYMB50);("]", SYMB51);("<<", SYMB52);(">>", SYMB53);("&", SYMB54);("=>", SYMB55);("~", SYMB56);(":pwd", SYMB57);(":cd", SYMB58);(":exit", SYMB59);(":type", SYMB60);(":desugar", SYMB61);(":parse", SYMB62);(",", SYMB63)]
